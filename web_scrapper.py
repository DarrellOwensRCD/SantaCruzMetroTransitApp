...
f.close()
#Get the user input
line_request = data["user_request"]["line"]
stop_request = data["user_request"]["stop"]
bound_request = data["user_request"]["direction"] #this only matters for 3 lines
...
#Bus Stop to URL
file = open("/Users/darrell/Documents/SantaCruzMetroGFTS/web_stops.txt", "r+")
