...
# Opening and Formatting Input files
...
# Search valid buses to create a response for
...
for bus in buses:
    if (bus["route"] != "OUT OF SERVICE/SORRY") and (bus["route"] != "LOOP OUT OF SERVICE AT BARN THEATER") and (bus["id"] != "90"):
        ...
        # Search for the closest stop by proximity
...
# Print and format list of loop ETAs to output file
